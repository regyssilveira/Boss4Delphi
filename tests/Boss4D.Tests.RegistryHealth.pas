...
type
  ...
  public
    ...
    [Test] procedure TestPublisherRepositoryCanDifferFromUpstream;
...
procedure TTestsRegistryHealth.TestPublisherRepositoryCanDifferFromUpstream;
begin
  WriteRegistryFile('index-v2.json',
    '{"schemaVersion":2,"includes":[],"sparse":[],"packages":[' +
    '{"name":"Upstream","publisher":"demo",' +
    '"repository":"github.com/upstream/project",' +
    '"publisherRepository":"github.com/demo/project",' +
    '"signerFingerprint":"' + StringOfChar('A', 40) +
    '","versions":[{"version":"1.0.0"}]}]}');
