...
begin
  FLogger.Log(TBoss4DLogLevel.Info, 'Boss4D - Gerenciador de Dependencias Delphi Nativo (v1.5.0)');
...
begin
  FLogger.Log(TBoss4DLogLevel.Info, 'v1.5.0-delphi-native');
end;
...
begin
  ...
  try
    LResult := LService.CheckAndDownload('1.5.0',
