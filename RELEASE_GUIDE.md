...
Para criar e apontar uma tag física (por exemplo, `v1.3.0`) para o commit atualizado:
```bash
...
gh release create v1.3.0 installer\Output\Boss4D_Setup.exe --title "v1.3.0" --notes "Sua descrição detalhada da release aqui"
```
